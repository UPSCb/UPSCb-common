...
if [ "${2##*.}" != "fa" ]; then
  echo "The second file needs to be a fasta file, i.e. have a .fa extension"
  usage
fi

if [ "${3##*.}" != "fa" ]; then
  echo "The third file needs to be a fasta file, i.e. have a .fa extension"
  usage
fi
...
if [ "${4##*.}" != "fa" ]; then
  echo "The forth file needs to be a fasta file, i.e. have a .fa extension"
  usage
fi
