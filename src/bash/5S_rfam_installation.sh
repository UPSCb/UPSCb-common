...
HTTPS_SERVER="ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/fasta_files/"
RFAM_VERSION="14.4"
REMOTE_DIR="$HTTPS_SERVER/$RFAM_VERSION"
FASTA_FILENAME="fasta/fasta_files/"
TAXO_PREFIX="tax_slv_lsu_${SILVA_VERSION/_/.}"

export KRAKEN2_FAST_BUILD="-F"
