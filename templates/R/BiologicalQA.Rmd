...
````{r}
p1 <- ggplot(pc.dat, aes(x=PC1, y=PC2, col=Time, shape=Treatment, fill=Genotype, text=Condition)) + 
  geom_point(size=2) + 
  ggtitle("Principal Component Analysis", subtitle="variance stabilized counts") +
  scale_fill_manual(values=c("aap1" = "White", "Col0" = "Black"))
...
This part is not necessary if there are no techincal replicates in the dataset. Set include=TRUE if you want to run it.
